...
function setWallet(privKey, pubKey, address) {
    Wallet[0] = privKey
    Wallet[1] = pubKey
    Wallet[2] = address
}
...
function getWallet() {
    if (Wallet.length) < 3 {
        return {getPrivKey(), getPubKey(), getAddresss()}
    } else {
        return Wallet
    }
}
...
export { signAndBroadcast, addExtraMsgConstructors, getChainId, setChainId, setWallet, clearWallet, resetLazyFactory}
